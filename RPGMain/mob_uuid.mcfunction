...
execute as @e[tag=sr.mob_uninited,c=1] run tellraw @a[tag=sr.rpg_bot] {"rawtext":[{"text":"sr.mob.spawn"},{"score":{"name":"@s","objective":"sr:ms_type"}},{"score":{"name":"@s","objective":"sr:ms_uuid"}},{"score":{"name":"@s","objective":"sr:ms_rtid"}}]}
